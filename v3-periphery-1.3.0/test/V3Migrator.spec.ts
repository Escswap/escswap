...
describe('V3Migrator', () => {
  ...
  let factoryV3: IEscswapV3Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IEscswapV2Pair
  ...
  beforeEach('add V2 liquidity', async () => {
    ...
    pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IEscswapV2Pair
