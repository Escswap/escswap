...
describe('NFTDescriptor', () => {
  ...
  function constructTokenMetadata(
    ...
    return {
      name: `Escswap - ${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
      description: `This NFT represents a liquidity position in a Escswap V3 ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
