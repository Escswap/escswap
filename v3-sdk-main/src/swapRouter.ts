...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@escswap/sdk-core'
...
import ISwapRouter from '@escswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the Escswap V3 SwapRouter, and has static methods for helping execute trades.
 */
