...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@escswap/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from '@escswap/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from '@escswap/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
...
/**
 * Represents the Escswap V3 QuoterV1 contract with a method for returning the formatted
