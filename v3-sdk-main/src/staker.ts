import { BigintIsh, Token, validateAndParseAddress } from '@escswap/sdk-core'
import { MethodParameters, toHex } from './utils/calldata'
import { defaultAbiCoder, Interface } from '@ethersproject/abi'
import IEscswapV3Staker from '@escswap/v3-staker/artifacts/contracts/EscswapV3Staker.sol/EscswapV3Staker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IEscswapV3Staker.abi)
