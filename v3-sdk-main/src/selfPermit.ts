import { BigintIsh, Token } from '@escswap/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@escswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
