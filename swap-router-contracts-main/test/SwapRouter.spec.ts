...
import { abi as PAIR_V2_ABI } from '@escswap/v2-core/build/EscswapV2Pair.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, Contract, ContractTransaction, Wallet } from 'ethers'
import { solidityPack } from 'ethers/lib/utils'
import { ethers, waffle } from 'hardhat'
import { IEscswapV2Pair, IWETH9, MockTimeSwapRouter02, MixedRouteQuoterV1, TestERC20 } from '../typechain'
...
describe('SwapRouter', function () {
  ...
  async function createV2Pool(tokenA: TestERC20, tokenB: TestERC20): Promise<IEscswapV2Pair> {
    await factoryV2.createPair(tokenA.address, tokenB.address)

    const pairAddress = await factoryV2.getPair(tokenA.address, tokenB.address)
    const pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IEscswapV2Pair
  ...
  describe('swaps - v2', () => {
    let pairs: IEscswapV2Pair[]
    let wethPairs: IEscswapV2Pair[]
