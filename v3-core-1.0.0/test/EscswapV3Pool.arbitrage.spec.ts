...
import { EscswapV3PoolSwapTest } from '../typechain/EscswapV3PoolSwapTest'
...
describe('EscswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('EscswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as EscswapV3PoolSwapTest
          ...
          let tester: EscswapV3PoolSwapTest
