...
describe('EscswapV3Pool', () => {
  ...
  let pool0: MockTimeEscswapV3Pool
  let pool1: MockTimeEscswapV3Pool
  ...
  let swapTargetCallee: TestEscswapV3Callee
  let swapTargetRouter: TestEscswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeEscswapV3Pool, any]> => {
