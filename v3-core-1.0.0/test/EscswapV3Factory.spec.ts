...
describe('EscswapV3Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as EscswapV3Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('EscswapV3Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('EscswapV3Pool')
