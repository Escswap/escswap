...
import '../../../../../contracts/EscswapV3Factory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the escswap factory will do when you create the pool
...
contract SetupEscswap {
    EscswapV3Pool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    EscswapV3Factory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new EscswapV3Factory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = EscswapV3Pool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract EscswapMinter {
    EscswapV3Pool pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    function setPool(EscswapV3Pool _pool) public {
        pool = _pool;
    }
