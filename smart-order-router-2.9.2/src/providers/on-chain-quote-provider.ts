...
import {
  ...
  MixedRouteSDK,
  Protocol,
} from '@escswap/router-sdk';
import { encodeRouteToPath } from '@escswap/v3-sdk';
...
import { EscswapMulticallProvider } from './multicall-escswap-provider';
...
export class OnChainQuoteProvider implements IOnChainQuoteProvider {
   ...
   * Only supports the Escswap Multicall contract as it needs the gas limitting functionality.
  ...
  constructor(
    ...
    // Only supports Escswap Multicall as it needs the gas limitting functionality.
