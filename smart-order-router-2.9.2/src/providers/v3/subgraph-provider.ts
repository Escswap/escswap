...
const SUBGRAPH_URL_BY_CHAIN: { [chainId in ChainId]?: string } = {
  [ChainId.MAINNET]:
    'https://api.thegraph.com/subgraphs/name/uniswap/escswap-v3',
  [ChainId.BSC]:
    'https://api.thegraph.com/subgraphs/name/uniswap/escswap-v3',
  [ChainId.RINKEBY]:
    'https://api.thegraph.com/subgraphs/name/ianlapham/escswap-v3-rinkeby',
  [ChainId.OPTIMISM]:
    'https://api.thegraph.com/subgraphs/name/ianlapham/optimism-post-regenesis',
  [ChainId.ARBITRUM_ONE]:
    'https://api.thegraph.com/subgraphs/name/ianlapham/arbitrum-minimal',
  [ChainId.POLYGON]:
    'https://api.thegraph.com/subgraphs/name/ianlapham/escswap-v3-polygon',
  [ChainId.CELO]:
    'https://api.thegraph.com/subgraphs/name/jesse-sawa/escswap-celo',
  [ChainId.GÖRLI]:
    'https://api.thegraph.com/subgraphs/name/ianlapham/escswap-v3-gorli',
};
