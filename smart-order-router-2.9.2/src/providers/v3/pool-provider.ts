...
import { computePoolAddress, FeeAmount, Pool } from '@escswap/v3-sdk';
import retry, { Options as RetryOptions } from 'async-retry';
import _ from 'lodash';

import { IEscswapV3PoolState__factory } from '../../types/v3/factories/IEscswapV3PoolState__factory';
  ...
  private async getPoolsData<TReturn>(
    ...
    const { results, blockNumber } = await retry(async () => {
      ...
      >({
        ...
        contractInterface: IEscswapV3PoolState__factory.createInterface(),
