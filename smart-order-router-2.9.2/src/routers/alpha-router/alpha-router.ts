...
import DEFAULT_TOKEN_LIST from '@escswap/default-token-list';
import { Protocol, SwapRouter, Trade } from '@escswap/router-sdk';
import { Currency, Fraction, Token, TradeType } from '@escswap/sdk-core';
import { TokenList } from '@escswap/token-lists';
import { Pair } from '@escswap/v2-sdk';
import {
  MethodParameters,
  Pool,
  Position,
...
export type AlphaRouterParams = {
   ...
   */
  multicall2Provider?: EscswapMulticallProvider;
  /**
   ...
   * Defaults to Escswap's unsupported token list.
   */
...
export type ProtocolPoolSelection = {
   ...
   * This is similar to how the legacy routing algorithm used by Escswap would select
    ...
    ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig>
{
  ...
  protected multicall2Provider: EscswapMulticallProvider;
  ...
  constructor({
    ...
    this.multicall2Provider =
      multicall2Provider ??
      new EscswapMulticallProvider(chainId, provider, 375_000);
    this.v3PoolProvider =
      v3PoolProvider ??
    ...
    // ipfs urls in the following format: `https://cloudflare-ipfs.com/ipns/api.escswap.org/v1/pools/${protocol}/${chainName}.json`;
      ...
      this.v2SubgraphProvider = new V2SubgraphProviderWithFallBacks([
        new CachingV2SubgraphProvider(
          ...
          new URISubgraphProvider(
            chainId,
            `https://cloudflare-ipfs.com/ipns/api.escswap.org/v1/pools/v2/${chainName}.json`,
            undefined,
            0
          ),
    ...
    if (v3SubgraphProvider) {
      ...
      this.v3SubgraphProvider = new V3SubgraphProviderWithFallBacks([
        new CachingV3SubgraphProvider(
          ...
          new URISubgraphProvider(
            chainId,
            `https://cloudflare-ipfs.com/ipns/api.escswap.org/v1/pools/v3/${chainName}.json`,
            undefined,
            0
          ),
          new NodeJSCache(new NodeCache({ stdTTL: 300, useClones: false }))
