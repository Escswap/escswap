...
import { SwapRouter, Trade } from '@escswap/router-sdk';
import { Currency, Token, TradeType } from '@escswap/sdk-core';
import { FeeAmount, MethodParameters, Pool, Route } from '@escswap/v3-sdk';
 ...
 * Code is mostly a copy from https://github.com/Escswap/escswap-interface/blob/0190b5a408c13016c87e1030ffc59326c085f389/src/hooks/useBestV3Trade.ts#L22-L23
