import { Token } from '@escswap/sdk-core';
import { FACTORY_ADDRESS } from '@escswap/v3-sdk';

import { ChainId, NETWORKS_WITH_SAME_ESCSWAP_ADDRESSES } from './chains';

const CELO_V3_CORE_FACTORY_ADDRESSES =
  '0xe53E340B70bbC2B7c3FB0B55a00E82Fef063e08A';
const CELO_QUOTER_ADDRESSES = '0x82825d0554fA07f7FC52Ab63c961F330fdEFa8E8';
const CELO_MULTICALL_ADDRESS = '0x90418134876653AF867f359E2a9aB963bc7aDDe8';
...
export const ESCSWAP_MULTICALL_ADDRESSES: AddressMap = {
...
export const SWAP_ROUTER_ADDRESS = '0xa7329fa0f3f4F2C2231292E3BFaE0f6AD3355d45';
export const V3_MIGRATOR_ADDRESS = '0xA5644E29708357803b5A882D272c41cC0dF92B34';
export const MULTICALL2_ADDRESS = '0x90418134876653AF867f359E2a9aB963bc7aDDe8';
...
export function constructSameAddressMap<T extends string>(
  ...
  return NETWORKS_WITH_SAME_ESCSWAP_ADDRESSES.concat(
    additionalNetworks
  ).reduce<{
    [chainId: number]: T;
  }>((memo, chainId) => {
