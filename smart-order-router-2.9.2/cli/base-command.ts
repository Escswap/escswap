...
import { Currency, CurrencyAmount, Token } from '@escswap/sdk-core';
import { MethodParameters } from '@escswap/v3-sdk';
...
export abstract class BaseCommand extends Command {
  ...
  private _multicall2Provider: EscswapMulticallProvider | null = null;
  ...
  async init() {
    ...
    this._log = bunyan.createLogger({
      name: 'Escswap Smart Order Router',
    ...
    const multicall2Provider = new EscswapMulticallProvider(chainId, provider);
