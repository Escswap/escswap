import { Currency, Fraction, Percent, Price, sortedInsert, CurrencyAmount, TradeType, Token } from '@escswap/sdk-core'
import { Pair } from '@escswap/v2-sdk'
import { BestTradeOptions, Pool } from '@escswap/v3-sdk'
 ...
 * @notice This class is functionally the same as the `Trade` class in the `@escswap/v3-sdk` package, aside from typing and some input validation.
 * @template TInput The input token, either Ether or an ERC-20
 * @template TOutput The output token, either Ether or an ERC-20
 * @template TTradeType The trade type, either exact input or exact output
 */
