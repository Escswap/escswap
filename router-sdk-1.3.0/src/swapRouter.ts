...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@escswap/sdk-core'
import { abi } from '@escswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
...
/**
 * Represents the Escswap V2 + V3 SwapRouter02, and has static methods for helping execute trades.
 */
