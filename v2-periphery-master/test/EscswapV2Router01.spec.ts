...
enum RouterVersion {
  EscswapV2Router01 = 'EscswapV2Router01',
  EscswapV2Router02 = 'EscswapV2Router02'
}

describe('EscswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.EscswapV2Router01]: fixture.router01,
        [RouterVersion.EscswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.EscswapV2Router01]: 101876,
              [RouterVersion.EscswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.EscswapV2Router01]: 138770,
              [RouterVersion.EscswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
