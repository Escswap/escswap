...
import { IEscswapV3Pool, TestERC20 } from '../../typechain'
...
export const getSlot0 = async (pool: IEscswapV3Pool) => {
  if (!pool.signer) {
...
export const getCurrentTick = async (pool: IEscswapV3Pool): Promise<number> => (await getSlot0(pool)).tick
