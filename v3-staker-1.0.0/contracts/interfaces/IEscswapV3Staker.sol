...
import '@escswap/v3-periphery/contracts/interfaces/IMulticall.sol';

/// @title Escswap V3 Staker Interface
/// @notice Allows staking nonfungible liquidity tokens in exchange for reward tokens
interface IEscswapV3Staker is IERC721Receiver, IMulticall {
    /// @param rewardToken The token being distributed as a reward
    /// @param pool The Escswap V3 pool
    ...
    /// @notice The Escswap V3 Factory
    function factory() external view returns (IEscswapV3Factory);
    ...
    /// @notice Withdraws a Escswap V3 LP token `tokenId` from this contract to the recipient `to`
    /// @param tokenId The unique identifier of an Escswap V3 LP token
    ...
    /// @notice Event emitted when a Escswap V3 LP token has been staked
    /// @param tokenId The unique identifier of an Escswap V3 LP token
    /// @param liquidity The amount of liquidity staked
    /// @param incentiveId The incentive in which the token is staking
    event TokenStaked(uint256 indexed tokenId, bytes32 indexed incentiveId, uint128 liquidity);

    /// @notice Event emitted when a Escswap V3 LP token has been unstaked
    /// @param tokenId The unique identifier of an Escswap V3 LP token
    /// @param incentiveId The incentive in which the token is staking
