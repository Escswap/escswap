...
interface ISwapRouterInterface extends ethers.utils.Interface {
  functions: {
    ...
    'escswapV3SwapCallback(int256,int256,bytes)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'escswapV3SwapCallback', values: [BigNumberish, BigNumberish, BytesLike]): string
  ...
  decodeFunctionResult(functionFragment: 'escswapV3SwapCallback', data: BytesLike): Result
...
export class ISwapRouter extends Contract {
  ...
  functions: {
    ...
    'escswapV3SwapCallback(int256,int256,bytes)'(
      amount0Delta: BigNumberish,
      amount1Delta: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
