...
describe('scenario:setFeeTo', () => {
  ...
  beforeEach('deploy escswap v2', async () => {
    factory = await deployContract(wallet, EscswapV2Factory, [timelock.address])
  })
  ...
  it('setFeeTo', async () => {
    ...
    const description = 'Set feeTo on the EscswapV2Factory to the timelock address.'

    // activate balances
    await esc.delegate(wallet.address)
