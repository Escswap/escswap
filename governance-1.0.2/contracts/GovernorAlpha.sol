...
contract GovernorAlpha {
    ...
    string public constant name = "Escswap Governor Alpha";
    ...
    /// @notice The address of the Escswap Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Escswap governance token
