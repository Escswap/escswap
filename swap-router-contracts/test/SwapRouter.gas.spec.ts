...
import { abi as IEscswapV3PoolABI } from '@escswap/v3-core/artifacts/contracts/interfaces/IEscswapV3Pool.sol/IEscswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { solidityPack } from 'ethers/lib/utils'
import { ethers, waffle } from 'hardhat'
import { IEscswapV3Pool, IWETH9, MockTimeSwapRouter02, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IEscswapV3Pool, IEscswapV3Pool, IEscswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IEscswapV3PoolABI, wallet)) as [
      IEscswapV3Pool,
      IEscswapV3Pool,
      IEscswapV3Pool
    ]
  ...
  let pools: [IEscswapV3Pool, IEscswapV3Pool, IEscswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestEscswapV3Callee')
