...
export function swapErrorToUserReadableMessage(error: any): ReactNode {
  ...
  switch (reason) {
    ...
    case 'EscswapV2Router: INSUFFICIENT_OUTPUT_AMOUNT':
    case 'EscswapV2Router: EXCESSIVE_INPUT_AMOUNT':
      return (
        <Trans>
    ...
    case 'EscswapV2: TRANSFER_FAILED':
      return <Trans>The output token cannot be transferred. There may be an issue with the output token.</Trans>
    case 'EscswapV2: K':
      return (
        <Trans>
          The Escswap invariant x*y=k was not satisfied by the swap. This usually means one of the tokens you are
    ...
    case 'STF':
      return (
        <Trans>
          ...
          transfer and rebase tokens are incompatible with Escswap V3.
        </Trans>
      )
    case 'TF':
      return (
        <Trans>
          ...
          rebase tokens are incompatible with Escswap V3.
        </Trans>
      )
    default:
      if (reason?.indexOf('undefined is not an object') !== -1) {
        ...
        return (
          <Trans>
            ...
            and rebase tokens are incompatible with Escswap V3.
          </Trans>
        )
      }
      return (
