...
import { Currency, CurrencyAmount, Token, TradeType } from '@escswap/sdk-core'
import { Route as V2Route } from '@escswap/v2-sdk'
import { Route as V3Route } from '@escswap/v3-sdk'
...
// from https://github.com/Escswap/routing-api/blob/main/lib/handlers/schema.ts
