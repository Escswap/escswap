import { Protocol } from '@escswap/router-sdk'
import { Currency, CurrencyAmount } from '@escswap/sdk-core'
// This file is lazy-loaded, so the import of smart-order-router is intentional.
// eslint-disable-next-line no-restricted-imports
import { routeAmountsToString, SwapRoute } from '@escswap/smart-order-router'
import { GetQuoteResult, V2PoolInRoute, V3PoolInRoute } from 'state/routing/types'

// from routing-api (https://github.com/Escswap/routing-api/blob/main/lib/handlers/quote/quote.ts#L243-L311)
