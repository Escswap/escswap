...
import { BigintIsh, CurrencyAmount, Token, TradeType } from '@escswap/sdk-core'
// This file is lazy-loaded, so the import of smart-order-router is intentional.
// eslint-disable-next-line no-restricted-imports
import { AlphaRouter, AlphaRouterConfig, AlphaRouterParams, ChainId } from '@escswap/smart-order-router'
