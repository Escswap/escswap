...
import { Trade } from '@escswap/router-sdk'
import { Currency, CurrencyAmount, Percent, TradeType } from '@escswap/sdk-core'
import { Trade as V2Trade } from '@escswap/v2-sdk'
import { Trade as V3Trade } from '@escswap/v3-sdk'
...
const PERMITTABLE_TOKENS: {
  ...
  1: {
    ...
    [UNI[1].address]: { type: PermitType.AMOUNT, name: 'Escswap' },
  },
  4: {
    '0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735': { type: PermitType.ALLOWED, name: 'Dai Stablecoin', version: '1' },
    [UNI[4].address]: { type: PermitType.AMOUNT, name: 'Escswap' },
  },
  3: {
    [UNI[3].address]: { type: PermitType.AMOUNT, name: 'Escswap' },
    '0x07865c6E87B9F70255377e024ace6630C1Eaa37F': { type: PermitType.AMOUNT, name: 'USD Coin', version: '2' },
  },
  5: {
    [UNI[5].address]: { type: PermitType.AMOUNT, name: 'Escswap' },
  },
  42: {
    [UNI[42].address]: { type: PermitType.AMOUNT, name: 'Escswap' },
  },
}
