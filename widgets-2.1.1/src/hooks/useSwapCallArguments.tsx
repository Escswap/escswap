...
import { Currency, Percent, TradeType } from '@escswap/sdk-core'
import { Router as V2SwapRouter, Trade as V2Trade } from '@escswap/v2-sdk'
import { FeeOptions, SwapRouter as V3SwapRouter, Trade as V3Trade } from '@escswap/v3-sdk'
