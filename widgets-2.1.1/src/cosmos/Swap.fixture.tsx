import { tokens } from '@escswap/default-token-list'
...
import {
  ...
  SupportedChainId,
  SwapWidget,
} from '@escswap/widgets'
import { CHAIN_NAMES_TO_IDS } from 'constants/chains'
import { useEffect } from 'react'
import { useValue } from 'react-cosmos/fixture'
import { Field } from 'state/swap'

import { DAI_MAINNET, USDC_MAINNET } from '../constants/tokens'
...
function Fixture() {
  ...
  const [routerUrl] = useValue('routerUrl', { defaultValue: 'https://api.escswap.org/v1/' })
